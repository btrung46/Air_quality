...
@endif
@if (session('error'))
    <div class="toast align-items-center bg-danger text-white position-fixed start-50 translate-middle-x shadow-lg fade show"
         role="alert" aria-live="assertive" aria-atomic="true"
         style="z-index: 1055; border-radius: 0.75rem; min-width: 320px; top: 40px;">
        <div class="d-flex">
            <div class="toast-body d-flex align-items-center gap-2 py-3">
