...
Route::get('/', [Current_dataController::class, 'index'])->name('dashboard')->middleware('auth');

Route::post('/save-player-id', [AuthController::class, 'savePlayerId'])->middleware('auth');
